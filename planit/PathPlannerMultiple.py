...
def filler(env_colladafile,context_graph,configFile):
	'''
	...
	trajectoryName=os.path.dirname(os.path.realpath(__file__))+'/trajectory/t1M.pk'
...
if __name__ == "__main__":
	...
	configFile="params/robotPosM.pk"
	filler(env_colladafile,context_graph,configFile)
